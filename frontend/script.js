/* =====================================
   VENNELA STORE - FRONTEND JAVASCRIPT
===================================== */

// 1. Backend URL

const API_URL = "https://ecommerce-web-app-81dd.onrender.com";
...
async function loadCart() {
    ...
    try {
        ...
        const productsHTML = cartItems.map(item => {
            const price =
                item.price || productPrices[item.productName] || 0;
...
async function loadOrders() {
    ...
    try {
        ...
        ordersList.innerHTML =
            "<p>Backend connection failed. Check the server.</p>";
    }
}